...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.bulkInsert('usuario', [
            { id: crypto.randomUUID(), email: 'aavp1603@gmail.com', passwordhash: await bcrypt.hash('patito', 10), nombre: 'Ale Pucheta', rolid: AdministradorUUID, protegido: true, createdAt: new Date(), updatedAt: new Date() },
