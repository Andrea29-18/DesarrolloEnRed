    ...
    public static void main(String[] args) throws SocketException, IOException {
        ...
        try (DatagramSocket socketUDP = new DatagramSocket(puerto)) {
            ...
            while (true) {
                ...
                System.out.println("Datagram recibido del host: " + peticion.getAddress());
                System.out.println("desde el puerto remoto: " + peticion.getPort());
                System.out.println("Datos recibidos: " + new String(peticion.getData()));

                LocalDateTime now = LocalDateTime.now();
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
                strFecha = now.format(formatter);
                System.out.println("La hora del servidor es: " + strFecha);

                try {
                    System.err.println("Simulamos un retardo en milisegundos: " + retardo);
